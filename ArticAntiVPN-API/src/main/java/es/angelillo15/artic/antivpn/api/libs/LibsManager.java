package es.angelillo15.artic.antivpn.api.libs;
...
public class LibsManager {
    ...
    public static void load(){
        Library hikariCP = Library.builder()
                ...
                .version("4.0.3")
                .id("hikariCP")
                .relocate("com{}zaxxer", "es{}angelillo15{}artic{}antivpn{}libs")
                .isolatedLoad(false)
                .build();
        ...
        Library yamlMerge = Library.builder()
                ...
                //.relocate("org{}slf4j", "es{}angelillo15{}artic{}antivpn{}libs{}slf4j")
        ...
        Library unirest = Library.builder()
                ...
                .relocate("org{}apache{}http", "es{}angelillo15{}artic{}antivpn{}libs{}http")
    ...
    public static Library getAdventureLib(String artifact) {
        Library lib = Library.builder()
                ...
                .isolatedLoad(false)
                .relocate("net{}kyori", "es{}angelillo15{}artic{}antivpn{}libs{}kyori")
                .build();
        return lib;
    }
}